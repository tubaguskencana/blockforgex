...
export default function StepPage({ total = 7 }) {
    ...
    const body = useMemo(() => {
        ...
        switch (n) {
            ...
            case 4: return <Step4 onNext={next} setSubmitter={(fn) => (submitRef.current = fn)} />
            case 5: return <Step5 onNext={next} setSubmitter={(fn) => (submitRef.current = fn)} />
            case 6: return <Step6 onNext={next} setSubmitter={(fn) => (submitRef.current = fn)} />
